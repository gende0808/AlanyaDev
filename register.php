                    ...
                    if (!$emailalreadyexists) {
						...
						Alanya Krommenie";
                            ...
                            try {
                                ...
                                $mail->SMTPAuth = true;
                                $mail->SMTPSecure = "";
                                $mail->Host = "mail.alanya-krommenie.nl";
                                $mail->Port = 587;
                                $mail->AddAddress($account->getUseremail());
                                $mail->Username = "noreply@alanya-krommenie.nl";
                                $mail->Password = "Harderwijk01";
                                $mail->SetFrom('noreply@alanya-krommenie.nl', 'Alanya Krommenie');
                                $mail->AddReplyTo("noreply@alanya-krommenie.nl", "Alanya Krommenie");
