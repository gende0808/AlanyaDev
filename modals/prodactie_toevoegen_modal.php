                        ...
                        <form action="actie_toevoegen.php" method="post" class="form-horizontal" role="form">
                            ...
                            <div id="datum3" style="display: none">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" style="border: 1px solid #949494;" value="<?php echo date('Y-m-d'); ?>" class="form-control" name="Begindatum" placeholder="Begindatum">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4 " for="Einddatum">Einddatum:</label>
                                    <div class="col-sm-8">
                                        <input type="date" style="border: 1px solid #949494;" class="form-control" name="Einddatum" placeholder="Einddatum">
                                    </div>
                                </div>
                                <hr>
                            </div>
