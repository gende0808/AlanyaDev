 ...
 * Time: 09:20
 */
class CategoryDiscount implements CRUD
{
    ...
    {
        try {
            $stmt = $this->db->prepare("INSERT INTO actiecategorie(
                                                    actieNaam,
                                                    actieOmschrijving,
                                                    actieBegindatum,
                                                    actieEindDatum,
    ...
    {
        $stmt = $this->db->prepare("DELETE FROM actiecategorie WHERE actieID= :actieid");
