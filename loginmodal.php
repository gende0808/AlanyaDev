                ...
                <form role="form" method="post" action="login.php">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="uLogin" name="loginemail" placeholder="E-mail">
                        </div>
                    </div> <!-- /.form-group -->
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" id="uPassword" name="loginpass" placeholder="Wachtwoord">
                        </div> <!-- /.input-group -->
                    </div> <!-- /.form-group -->
                    <p>Nog geen account? <a href="register.php">Registreren</a></p>
                    <button class="form-control btn orange" type="submit" style="color: white;">Login</button>
                </form>
            </div> <!-- /.modal-body -->
